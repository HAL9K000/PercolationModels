...
int main() {
    ...
    cout << "Enter divisions (i.e spacing between p-values): ";
    cin >> divisions;
	...
	theoretical_percolation_probabilities_np(grid_size,p_start,p_end,divisions,r_init, number_of_census,lag);
