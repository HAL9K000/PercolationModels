...
int main() {
  ...
  cin >> how_many; */
	...
	f_coordinates PQ[divisions] = {{0.5, 0.07}, {0.52, 0.07}, {0.54, 0.07}, {0.56, 0.07}, {0.58, 0.07}, {0.6, 0.07}, {0.62, 0.07}, {0.64, 0.07},
	{0.66, 0.07}, {0.68, 0.07}, {0.70, 0.07}, {0.71, 0.07}, {0.718261719, 0.07}, {0.72, 0.07}, {0.74, 0.07}, {0.76, 0.07}, {0.78, 0.07},
	{0.8, 0.07}, {0.82, 0.07}, {0.84, 0.07}, {0.86, 0.07}, {0.88, 0.07}, {0.9, 0.07}, {0.92, 0.07}};
