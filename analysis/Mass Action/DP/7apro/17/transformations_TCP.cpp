...
int main() {
  ...
  cin >> how_many; */
	...
	f_coordinates PQ[divisions] = {{0.5, 0.09}, {0.52, 0.09}, {0.54, 0.09}, {0.56, 0.09}, {0.58, 0.09}, {0.6, 0.09}, {0.62, 0.09}, {0.64, 0.09},
	{0.66, 0.09}, {0.68, 0.09}, {0.70, 0.09}, {0.71, 0.09}, {0.715192159, 0.09}, {0.72, 0.09}, {0.74, 0.09}, {0.76, 0.09}, {0.78, 0.09},
	{0.8, 0.09}, {0.82, 0.09}, {0.84, 0.09}, {0.86, 0.09}, {0.88, 0.09}, {0.9, 0.09}, {0.92, 0.09}};
